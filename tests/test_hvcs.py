...
#     url = ('https://github.hc.ac/api/v3/repos/relekang/rmoq/commits/'
...
#     url = 'https://github.hc.ac/api/v3/repos/relekang/rmoq/releases'
#     edit_url = 'https://github.hc.ac/api/v3/repos/relekang/rmoq/releases/1'
#     get_url = 'https://github.hc.ac/api/v3/repos/relekang/rmoq/releases/tags/v1.0.0'
#
#     @responses.activate
